...
def time_series_analysis(target: str, df: pd.DataFrame, path=None):
    ...
    train_data = TimeSeriesDataFrame.from_data_frame(
        df, id_column="item_id", timestamp_column="Time"
    )
...
time_series_analysis(
    "temperature_max",
    load_csv_data("addy_total_average_north_america.csv"),
    path="total-average-north-america-time-temp",
)
